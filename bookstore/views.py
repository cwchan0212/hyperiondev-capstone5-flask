...
def book_form():
    ...
    if request.method == "POST": 
        ...
        if book_action == "add":
            ...
            # Submit Book form for adding new book
                ...
                # If no message, check any duplicate books
                    ...
                    # If No books found, add the new book
                    else:
        ...
        # If book_action is edit, load Book form for editing books         
            ...
            if book_action_save == "":
                ...
                # Store the book list to dictionary
                book_dictionary = {
        ...
        # If book_action is remove, delete Book by book id
            ...
            # if book id is not found, flash message to notify the user
                ...
                books = Book.all_books()
                return render_template("public/book/index.html", books=books)
        # For any other cases, load Book index page
        else:  
            books = Book.all_books()
            return render_template("public/book/index.html", books=books)
...
def book_search():
    ...
    # Submit Book search request
        ...
        # If message exists, flash message to notify the user
        if message:
            flash(message)
            return render_template("public/book/index.html", search_dictionary=search_dictionary)
...
# Function get_book_dictionary to convert the input book items to dictionary (for Book from)
def get_book_dictionary(form_dictionary):
    book_field_list = ["title", "author", "description", "quantity"]
    book_dictionary = {}
    message = None
    # Check all inputs of Book form
    ...
    # Return messasge and book dictionary
    return [message, book_dictionary]

#----------------------------------------------------------------------------------------------------------------------

# Create datetime filter to convert date format for template
